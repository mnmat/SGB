...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load("img/canoe_full.png")
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        self.car_width = 49

        # enemy_car
        self.enemy_car = pygame.image.load("img/hippo.png")
        ...
        # reward
        self.reward = pygame.image.load("img/Croc.png")
        ...
        # Background
        self.bgImg = pygame.image.load("img/jungle.png")
        self.bg_x1 = 0
        self.bg_x2 = 0
        self.bg_y1 = 0
        self.bg_y2 = -600
    ...
    def run_car(self):
        ...
        while not self.crashed:
            ...
            self.run_reward(self.reward_startx, self.reward_starty)
            ...
            #    print(self.bg_speed, self.enemy_car_speed)
    ...
    def run_reward(self, thingx, thingy):
        self.gameDisplay.blit(self.reward, (thingx, thingy))
