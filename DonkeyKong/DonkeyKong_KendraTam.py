...
title = pygame.image.load(path_g+"title-screen.png")
start = pygame.image.load(path_g+"start.png")
winScreen = pygame.image.load(path_g+"win-screen.png")
gameOverScreen = pygame.image.load(path_g+"game-over-screen.png")

selectIcon = pygame.image.load(path_g+"select-icon.png")
life = pygame.image.load(path_g+"mario-life.png")

withLadder = pygame.image.load(path_g+"withLadder.png")
platform0 = pygame.image.load(path_g+"platform0.png")
platform1 = pygame.image.load(path_g+"platform1.png")
platform2 = pygame.image.load(path_g+"platform2.png")
platform3 = pygame.image.load(path_g+"platform3.png")
platform4 = pygame.image.load(path_g+"platform4.png")
platform5 = pygame.image.load(path_g+"platform5.png")
platform6 = pygame.image.load(path_g+"platform6.png")
platforms = [platform0, platform1, platform2, platform3, platform4, platform5, platform6]
level = pygame.image.load(path_g+"level.png")

blue0 = pygame.image.load(path_g+"blue0.png")
blue1 = pygame.image.load(path_g+"blue1.png")
blue2 = pygame.image.load(path_g+"blue2.png")
blue3 = pygame.image.load(path_g+"blue3.png")
blue4 = pygame.image.load(path_g+"blue4.png")
blue5 = pygame.image.load(path_g+"blue5.png")
blueNumbers = [blue0, blue1, blue2, blue3, blue4, blue5]
white0 = pygame.image.load(path_g+"white0.png")
white1 = pygame.image.load(path_g+"white1.png")
white2 = pygame.image.load(path_g+"white2.png")
white3 = pygame.image.load(path_g+"white3.png")
white4 = pygame.image.load(path_g+"white4.png")
white5 = pygame.image.load(path_g+"white5.png")
white6 = pygame.image.load(path_g+"white6.png")
white7 = pygame.image.load(path_g+"white7.png")
white8 = pygame.image.load(path_g+"white8.png")
white9 = pygame.image.load(path_g+"white9.png")
whiteNumbers = [white0, white1, white2, white3, white4, white5, white6, white7, white8, white9]

marioLeft = pygame.image.load(path_g+"julian.png")
marioRight = pygame.image.load(path_g+"julian.png")
runLeft = pygame.image.load(path_g+"julian.png")
runRight = pygame.image.load(path_g+"julian.png")
marioJumpLeft = pygame.image.load(path_g+"julian.png")
marioJumpRight = pygame.image.load(path_g+"julian.png")
marioClimb1 = pygame.image.load(path_g+"julian.png")
marioClimb2 = pygame.image.load(path_g+"julian.png")
dead = pygame.image.load(path_g+"julian_vomit.png")
marioImage = marioRight

paulineHelp = pygame.image.load(path_g+"hannah_stand.png")
paulineStill = pygame.image.load(path_g+"hannah_stand.png")

dkUp1 = pygame.image.load(path_g+"DK_up1.png")
dkUp2 = pygame.image.load(path_g+"DK_up2.png")
dkEmptyClimb1 = pygame.image.load(path_g+"dkClimbEmpty1.png")
dkEmptyClimb2 = pygame.image.load(path_g+"dkClimbEmpty2.png")
dkForward = pygame.image.load(path_g+"dkForward.png")
dkLeft = pygame.image.load(path_g+"dkLeft.png")
dkRight = pygame.image.load(path_g+"dkRight.png")
dkDefeat = pygame.image.load(path_g+"DK-defeat.png")
dkImage = dkForward

barrelStack = pygame.image.load(path_g+"ottakringer_stack.png")
barrelDown = pygame.image.load(path_g+"ottakringer_down.png")
barrel1 = pygame.image.load(path_g+"ottakringer_top1.png")
barrel2 = pygame.image.load(path_g+"ottakringer_top2.png")
barrel3 = pygame.image.load(path_g+"ottakringer_top3.png")
barrel4 = pygame.image.load(path_g+"ottakringer_top4.png")
barrelSequence = [barrel1, barrel2, barrel3, barrel4]
barrelPic = []

brokenHeart = pygame.image.load(path_g+"broken-heart.png")
fullHeart = pygame.image.load(path_g+"full-heart.png")
...
def redraw_screen():
    ...
    if gameDone:
        ...
        if pressed == False:
            ...
            #calls drawing fucntions
            if not mixer.music.get_busy(): sound("Intro")
            introScene()
            marioLives()
            clock.tick(12)
            ...
            #calls drawing fucntions
            if not hit:
                if not mixer.music.get_busy(): sound("Background")
            background()
            dk()
            mario()
            pauline(paulineHelp)
