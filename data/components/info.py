...
class OverheadInfo(object):
    ...
    def create_info_labels(self):
        ...
        self.create_label(self.mario_label, 'GIULIO', 75, 30)
    ...
    def create_main_menu_labels(self):
        ...
        self.create_label(level_one, 'L 1', 50, 360)
        self.create_label(level_two, 'L 2', 50, 405)
        self.create_label(level_three, 'L 3', 250, 360)
        self.create_label(level_four, 'L 4', 250, 405)
        self.create_label(level_five, 'L 5', 450, 360)
        self.create_label(level_six, 'L 6', 450, 405)
        self.create_label(level_seven, 'L 7', 650, 360)

        self.create_label(top, 'TOP - ', 290, 465)
        self.create_label(top_score, '000000', 400, 465)

        self.main_menu_labels = [level_one, level_two, level_three, level_four, level_five, level_six, level_seven,
                                 top, top_score]
    ...
    def handle_level_state(self, level_info):
        ...
        if self.state == c.MAIN_MENU:
            ...
            self.update_score_images(self.main_menu_labels[-1], self.top_score)
    ...
    def draw_level_screen_info(self, surface):
        """Draws info during regular game ple"""
        for info in self.score_images:
            surface.blit(info.image, info.rect)
