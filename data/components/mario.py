...
class Mario(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.sprite_sheet = setup.GFX['giulio_bros']
    ...
    def load_images_from_sheet(self):
        ...
        self.right_small_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right [0]
        self.right_small_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right walking 1 [1]
        self.right_small_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right walking 2 [2]
        self.right_small_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right walking 3 [3]
        self.right_small_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right jump [4]
        self.right_small_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right skid [5]
        self.right_small_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Death frame [6]
        self.right_small_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Transition small to big [7]
        self.right_small_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Transition big to small [8]
        self.right_small_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Frame 1 of flag pole Slide [9]
        self.right_small_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Frame 2 of flag pole slide [10]
        ...
        self.right_small_green_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right standing [0]
        self.right_small_green_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right walking 1 [1]
        self.right_small_green_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right walking 2 [2]
        ...
        self.right_big_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right skid [5]
        self.right_big_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right throwing [6]
        self.right_big_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right crouching [7]
        self.right_big_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Transition big to small [8]
        self.right_big_normal_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Frame 1 of flag pole slide [9]
        ...
        self.right_fire_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Right crouching [7]
        self.right_fire_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Place holder [8]
        self.right_fire_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Frame 1 of flag pole slide [9]
        self.right_fire_frames.append(
            self.get_image(0, 36*n, 24, 36))  # Frame 2 of flag pole slide [10]
        ...
        #Images for invisible Mario#

        n = 10

        self.invisible.append(
            self.get_image(0, 36*10, 24,36))
